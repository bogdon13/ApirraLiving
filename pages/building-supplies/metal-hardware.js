...
function App() {
  return (
    <div style={{ textAlign: "center" }}>
      <Navbar></Navbar>
      <Parallax bgImage="/metal-accessories.jpg" strength={500}>
        <div style={{ height: 800 }}>
          <h1 style={inlineStyle}>Shower Accessories</h1>
        </div>
      ...
      <h1></h1>
      <Parallax bgImage="/railing-accessories.jpg" strength={500}>
        <div style={{ height: 800 }}>
          <h1 style={inlineStyle}>Railing Accessories</h1>
        </div>
        <div style={{ height: 400 }}>
          <div style={inlineStyle2}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam
